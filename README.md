...
End-to-end video analytics platform measuring engagement metrics across 200K+ daily events
...
```bash
git clone https://github.com/Amanroy666/Video-Analytics-Dashboard.git
